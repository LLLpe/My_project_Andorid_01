...
Shader "QF/NssFX/NssFX_ASE/FX_ASE_Sparkle_Paxton00123"
{
	Properties
	{
		...
		_GlitterSpeed("GlitterSpeed", Float) = 0.5
		_Alphaweight("Alpha权重", Range( 0 , 1)) = 1
		_GlitterMap("GlitterMap", 2D) = "black" {}
		...
		_SprkleDissolve("外层闪点消融", Range( 0 , 1)) = 0.8352941
		_SprkleVornojScale("外层闪点消融扭曲比例", Float) = 1
		_SprkleShinSpeed("外层闪点闪烁速度", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float simplePerlin2D800 = snoise( appendResult44_g5*_SprkleVornojScale );
				simplePerlin2D800 = simplePerlin2D800*0.5 + 0.5;
				float3 temp_cast_11 = (simplePerlin2D800).xxx;
				float2 texCoord910 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float GlitterSpeed898 = _GlitterSpeed;
				float4 GlitterColor905 = tex2Dlod( _GlitterMap, float4( ( ( float3( texCoord910 ,  0.0 ) + ( ase_worldViewDir * 0.05 * GlitterSpeed898 ) ) * ( ( GlitterSpeed898 / 2.0 ) + 1.0 ) * _SparkleTilling ).xy, 0, 0.0) );
				...
				float4 GlitterColor2880 = tex2Dlod( _GlitterMap, float4( ( ( appendResult872 + uvCenter890 ) * ( 1.0 - ( GlitterSpeed898 / 3.14 ) ) * _SparkleTilling ), 0, 0.0) );
				float3 temp_cast_14 = (_GlitterContrast).xxx;
				float3 lerpResult916 = lerp( pow( (( _GlitterPower * GlitterColor905 * GlitterColor2880 )).rgb , temp_cast_14 ) , float3( 0,0,0 ) , ( 1.0 - GlitterColor2880 ).rgb);
				float3 Glitter_new922 = lerpResult916;
				float3 temp_cast_16 = (_SprkleDissolve).xxx;
				float3 temp_output_486_0 = pow( Glitter_new922 , temp_cast_16 );
				float4 SparkleCol504 = ( float4( step( temp_cast_11 , temp_output_486_0 ) , 0.0 ) * _SparkIntenrity * _SparkleColor );
				...
				float3 Color = ( ( tex2DNode308 * _Tint ) + ReflectCol349 + SpecularColor333 + ( ( StarryCol298 * pow( ( lerpResult464 + 0.2 ) , temp_cast_9 ) * tex2DNode556 ) + ( SparkleCol504 * pow( ( lerpResult736 + 0.2 ) , temp_cast_19 ) ) ) + ( xingkong777 * tex2DNode556 ) + saturate( ( fresnelNode807 * _FCol ) ) ).rgb;
...
Node;AmplifyShaderEditor.CommentaryNode;746;-7509.381,324.8647;Inherit;False;2507.689;1199.531;SparkleColor;3;472;471;618;SparkleColor;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;472;-7480.39,569.5578;Inherit;False;1587.962;614.7743;NoiseMask1;17;522;519;521;506;486;558;559;560;557;561;581;617;858;859;924;854;616;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;328;-8918.162,3909.629;Inherit;False;Property;_SpecularGloss;SpecularGloss;15;0;Create;True;0;0;0;False;0;False;100;8;0.01;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;329;-8496.79,3903.197;Inherit;False;Property;_SpecularPower;SpecularPower;16;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;332;-8498.281,3973.95;Inherit;False;Property;_SpecularColor;SpecularColor;17;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;367;-10244.37,3643.008;Inherit;True;Property;_sarMask;sarMask;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;786;-5016.518,5600.745;Inherit;False;Property;_Offset;Offset;57;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;785;-3602.144,5122.852;Inherit;False;Property;_Tilling1;Tilling 1;56;0;Create;True;0;0;0;False;0;False;1,1;2.3,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;811;-3343.611,2716.415;Inherit;False;Property;_FCol;FCol;58;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.6099442,0.6840961,0.7547169,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;792;-4272.229,4989.555;Inherit;False;Property;_Height3;Height3;54;0;Create;True;0;0;0;False;0;False;0;-2;-15;15;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;799;-3826.448,4775.678;Inherit;False;Property;_xingkongHue;星空饱和度;55;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;363;-9572.196,2230.883;Inherit;False;Property;_FrsnelIntensity;FrsnelIntensity;34;0;Create;True;0;0;0;False;0;False;1;0.321;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;359;-9574.433,2400.396;Inherit;True;Property;_FresnelMap;FresnelMap;7;0;Create;True;0;0;0;False;0;False;-1;None;357516955bc394d489bf350347f0cf95;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;364;-8595.469,3235.798;Inherit;False;Property;_ReflectPower;Reflect Power;18;0;Create;True;0;0;0;False;0;False;1;0.148;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;360;-8603.279,3017.608;Inherit;True;Property;_ReflectMap;ReflectMap;9;0;Create;True;0;0;0;False;0;False;-1;None;329a792ec57d56b42b61b6c449e42c32;True;0;False;black;LockedToTexture2D;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;362;-9238.712,2505.728;Inherit;False;Property;_Float8;Float 8;35;0;Create;True;0;0;0;False;0;False;0.1;1.4;0.1;16;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;720;-6293.075,1953.6;Inherit;False;Property;_Height02;内层闪点02高度;46;0;Create;False;0;0;0;False;0;False;-1;-3;-15;15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;371;-9655.743,1519.845;Inherit;False;Property;_RandomMapTillingSpeed;RandomMapTillingSpeed;19;0;Create;True;0;0;0;False;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;376;-8595.685,1867.112;Inherit;False;Property;_RandomWeight;RandomWeight;20;0;Create;True;0;0;0;False;0;False;0;0.474;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;382;-9220.667,1251.523;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;383;-9418.061,1386.897;Inherit;False;Property;_VertexWeight;VertexWeight;33;0;Create;True;0;0;0;False;0;False;0;0.091;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;384;-8674.019,1200.05;Inherit;False;Property;_Height;Height;36;0;Create;True;0;0;0;False;0;False;1.640666;-1;-15;15;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;381;-9415.965,1229.669;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;380;-8603.984,1670.425;Inherit;True;Property;_RandomMap;RandomMap;14;0;Create;True;0;0;0;False;0;False;-1;None;db59a147e05cbd94993ee81b8097c979;True;2;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;815;-3689.413,2634.917;Inherit;False;Property;_FresnaelPower;FresnaelPower;59;0;Create;True;0;0;0;False;0;False;5;2.97;0.1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;308;-3409.598,2966.642;Inherit;True;Property;_DiffueMap;Diffue Map;0;0;Create;True;0;0;0;False;0;False;-1;None;28e5211da70604145a23909dac70588f;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;744;-3321.885,3194.823;Inherit;False;Property;_Tint;Tint;4;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.899371,0.899371,0.899371,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;752;-1926.378,2988.521;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;QF/NssFX/NssFX_ASE/FX_ASE_Sparkle_Paxton00123;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;IgnoreProjector=True;True;3;True;12;all;0;False;True;0;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;False;False;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;1;638412318563925137;Forward Only;0;0;Cast Shadows;0;638412315392944719;  Use Shadow Threshold;0;0;Receive Shadows;0;638412315401366939;GPU Instancing;0;638412315406847438;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;1;638412315435672200;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;True;True;False;True;False;False;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;766;-3256.909,3443.902;Inherit;False;Property;_Alphaweight;Alpha权重;2;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;689;-5583.282,4537.006;Inherit;False;Property;_Starry2Intensity;内层闪点02强度;44;0;Create;False;0;0;0;False;0;False;1;0.695;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;685;-5267.414,4607.373;Inherit;False;Property;_Starry2Spec;内层闪点02高光区域;48;0;Create;False;0;0;0;False;0;False;1;0.02;0.02;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;684;-5546.541,4353.958;Inherit;False;Property;_Starry2Color;内层闪点02颜色;45;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;0.7204026,0.9526433,0.9748427,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;730;-6466,4106.412;Inherit;False;Property;_Starry2Tilling;内层闪点02重复;47;0;Create;False;0;0;0;False;0;False;20;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;699;-7279.137,4106.612;Inherit;False;Property;_Starry2Speed;内层闪点02速度;49;0;Create;False;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;775;-3240.976,5242.815;Inherit;False;Property;_xingkongIntensity;星空颜色强度;53;0;Create;False;0;0;0;False;0;False;0;0.199;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;365;-9640.606,355.6091;Inherit;True;Property;_NormalMap;NormalMap;8;0;Create;True;0;0;0;False;0;False;-1;None;7ef7fd4114f08bf419334b8753f4225a;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;557;-7412.978,797.7476;Inherit;False;Constant;_Float36;Float 36;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;558;-7099.983,803.3247;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;559;-7211.652,925.611;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;773;-3255.064,5003.75;Inherit;True;Property;_SkyTex;星空;52;0;Create;False;0;0;0;False;0;False;-1;None;f52b9f89907516d4a88a9f2f3f8e8dcb;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;521;-7010.089,645.231;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;561;-7473.045,1010.784;Inherit;False;Property;_SprkleSpeed01;外层闪点流动速度;26;0;Create;False;0;0;0;False;0;False;0.1;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;573;-7013.327,-166.9637;Inherit;True;Twirl;-1;;5;90936742ac32db8449cd21ab6dd337c8;0;4;1;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT;0;False;4;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;575;-7402.403,-239.3562;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;239;-7328.219,2855.463;Inherit;False;Property;_StarryFlowSpeed;内层闪点流动速度;40;0;Create;False;0;0;0;False;0;False;1;0.329;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;857;-7116.183,3424.473;Inherit;False;Property;_SparkshinFreq;内层闪点01转动闪烁频率;41;0;Create;False;0;0;0;False;0;False;1;0.072;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;257;-5608.546,2877.868;Inherit;False;Property;_StarryPower;StarryPower;50;0;Create;True;0;0;0;False;0;False;20;11;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;294;-5528.546,3245.868;Inherit;False;Property;_Starry1Intensity;内层闪点强度;37;0;Create;False;0;0;0;False;0;False;1;0.583;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;248;-5528.546,3069.868;Inherit;False;Property;_Starry1Color;内层闪点颜色;38;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;0.7644871,0.9294407,0.9685534,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;452;-5304.546,3325.868;Inherit;False;Property;_Starry1Spec;内层闪点高光区域;43;0;Create;False;0;0;0;False;0;False;1;3.1;0.02;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;234;-6440.546,2781.868;Inherit;False;Property;_Starry1Tilling;内层闪点Tilling;39;0;Create;False;0;0;0;False;0;False;20;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;765;-7417.111,1886.849;Inherit;False;Property;_Height1;内层闪点01高度;42;0;Create;False;0;0;0;False;0;False;0;-0.3;-15;15;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;560;-7389.171,926.8478;Inherit;False;1;0;FLOAT;0.1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;858;-6870.203,644.1029;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;574;-6976.897,69.0624;Inherit;False;Property;_SprkleVornojScale;外层闪点消融扭曲比例;30;0;Create;False;0;0;0;False;0;False;1;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;577;-7410.75,-123.7015;Inherit;False;Property;_SprkleVornojStrength;外层闪点消融扭曲强度;32;0;Create;False;0;0;0;False;0;False;21.9;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;505;-5523.14,621.8668;Inherit;False;3;3;0;FLOAT3;1,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;749;-5620.401,933.7418;Inherit;False;Property;_SparkleColor;外层闪点颜色;25;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StepOpNode;506;-6055.165,632.4595;Inherit;True;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;887;-3923.442,459.5424;Inherit;False;890;uvCenter;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;896;-4239.992,-504.5934;Inherit;False;Property;_GlitterSpeed;GlitterSpeed;1;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;519;-6728.499,633.267;Inherit;True;Property;_SparkleMap;SparkleMap;10;0;Create;True;0;0;0;False;0;False;-1;None;b9e28bf2fd0f6754f8a8640f8aea489d;True;2;False;black;Auto;False;Object;-1;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;800;-6697.836,-159.2357;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;436;-6040.546,2477.868;Inherit;True;Property;_StarryMap;StarryMap;11;0;Create;True;0;0;0;False;0;False;-1;None;a26bfdd73e091e949a32a0c695ec59e6;True;1;False;black;Auto;False;Object;-1;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;437;-6024.546,3005.868;Inherit;True;Property;_TextureSample1;Texture Sample 1;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;1;False;white;Auto;False;Instance;436;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;611;-5793.414,822.1499;Inherit;False;Property;_SparkIntenrity;外层闪点强度;21;0;Create;False;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;907;-2683.674,-335.569;Inherit;True;Property;_GlitterMap;GlitterMap;3;0;Create;True;0;0;0;False;0;False;-1;None;b9e28bf2fd0f6754f8a8640f8aea489d;True;0;False;black;Auto;False;Object;-1;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;879;-2641.695,180.989;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;b9e28bf2fd0f6754f8a8640f8aea489d;b9e28bf2fd0f6754f8a8640f8aea489d;True;0;False;white;Auto;False;Instance;907;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;913;-3548.44,658.2909;Inherit;False;Property;_GlitterPower;GlitterPower;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;921;-3224.572,876.7823;Inherit;False;Property;_GlitterContrast;GlitterContrast;27;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;918;-3232.888,945.2057;Inherit;False;880;GlitterColor2;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;854;-6086.64,971.9336;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PowerNode;616;-6285.512,1042.865;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;618;-6631.059,1199.699;Inherit;False;Property;_SparkSpec;外层闪点高光区域;28;0;Create;False;0;0;0;False;0;False;1;0.02;0.02;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;617;-6540.124,1046.272;Inherit;False;434;Thichness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;486;-6370.242,821.8722;Inherit;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;924;-6707.54,828.0796;Inherit;False;922;Glitter_new;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;466;-3840.028,4108.867;Inherit;False;Property;_StarryHue;StarryHue;51;0;Create;True;0;0;0;False;0;False;0;0.076;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;741;-3853.104,4407.523;Inherit;False;Property;_SparkHue;外层闪点饱和度;22;0;Create;False;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;461;-3860.181,3906.009;Inherit;True;Property;_ColorMap;ColorMap;13;0;Create;True;0;0;0;False;0;False;-1;None;e4b38866534f2ca44a2e09b37542955a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;556;-2973.229,4291.688;Inherit;True;Property;_ShiningMask;ShiningMask;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;588;-3191.759,4164.604;Inherit;False;504;SparkleCol;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;580;-7454.396,32.93082;Inherit;False;Property;_SprkleShinSpeed;外层闪点闪烁速度;31;0;Create;False;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;925;-3095.43,-46.87357;Inherit;False;Property;_SparkleTilling;外层闪点Tilling;23;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;859;-7027.537,925.4366;Inherit;False;Property;_Float6;外层闪点Tilling;24;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;581;-6799.465,933.1118;Inherit;False;Property;_SprkleDissolve;外层闪点消融;29;0;Create;False;0;0;0;False;0;False;0.8352941;1;0;1;0;1;FLOAT;0
...
WireConnection;854;0;486;0
WireConnection;854;1;616;0
WireConnection;616;0;617;0
WireConnection;616;1;618;0
WireConnection;486;0;924;0
WireConnection;486;1;581;0
...
ASEEND*/
//CHKSM=6A2E860E66A4BA095504A54A2F8C3EC49DDC174B